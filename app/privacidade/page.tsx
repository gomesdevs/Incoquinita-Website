    ...
    <Section>
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose-dark mt-8 space-y-6 text-sm leading-relaxed text-text-muted">
          ...
          <h2 className="font-display text-lg font-bold text-text-primary">1. Dados Coletados</h2>
          <p>
          ...
          <h2 className="font-display text-lg font-bold text-text-primary">2. Uso dos Dados</h2>
          ...
          <h2 className="font-display text-lg font-bold text-text-primary">3. Compartilhamento</h2>
          <p>
          ...
          <h2 className="font-display text-lg font-bold text-text-primary">4. Segurança</h2>
          <p>
          ...
          <h2 className="font-display text-lg font-bold text-text-primary">5. Cookies</h2>
          <p>
          ...
          <h2 className="font-display text-lg font-bold text-text-primary">6. Seus Direitos</h2>
          <p>
          ...
          <h2 className="font-display text-lg font-bold text-text-primary">7. Contato</h2>
          <p>
