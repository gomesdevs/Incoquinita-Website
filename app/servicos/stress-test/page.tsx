    ...
    <>
      <Section className="pb-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            ...
            <h1 className="font-display text-4xl font-bold tracking-tight text-text-primary sm:text-5xl">Teste de Carga e Resistência</h1>
            <p className="mt-4 text-lg leading-relaxed text-text-muted">Validação da capacidade da sua aplicação de suportar carga, identificando gargalos e estimando limites de performance.</p>
            <div className="mt-6 flex flex-wrap gap-2"><Badge variant="accent">k6</Badge><Badge variant="accent">JMeter</Badge><Badge variant="accent">Locust</Badge></div>
          </div>
        </div>
      </Section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-text-muted leading-relaxed">Aplicações que não são testadas sob carga falham nos momentos críticos — Black Friday, lançamentos, picos de uso. Uma falha de performance pode causar perda de receita e credibilidade.</p>
            </div>
            <div>
      ...
      <Section>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-display text-2xl font-bold text-text-primary">Valide sua performance</h2>
          <p className="mt-2 text-text-muted">Solicite uma proposta para Teste de Carga.</p>
