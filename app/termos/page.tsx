    ...
    <Section>
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose-dark mt-8 space-y-6 text-sm leading-relaxed text-text-muted">
          ...
          <h2 className="font-display text-lg font-normal text-text-primary">1. Aceitação</h2>
          <p>
            Ao acessar e utilizar o site da Incoquinita, você concorda com estes termos de uso.
            Caso não concorde, não utilize o site.
          </p>

          <h2 className="font-display text-lg font-normal text-text-primary">2. Uso do Site</h2>
          <p>
          ...
          <h2 className="font-display text-lg font-normal text-text-primary">3. Propriedade Intelectual</h2>
          <p>
            Todo o conteúdo do site (textos, logotipos, gráficos, código) é propriedade da
            Incoquinita e protegido por direitos autorais.
          </p>

          <h2 className="font-display text-lg font-normal text-text-primary">4. Limitação de Responsabilidade</h2>
          <p>
          ...
          <h2 className="font-display text-lg font-normal text-text-primary">5. Links Externos</h2>
          <p>
          ...
          <h2 className="font-display text-lg font-normal text-text-primary">6. Alterações</h2>
          <p>
